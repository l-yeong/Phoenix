...
//        int code = seatService.tryLockSeat(req.getMno(), req.getShowId(), req.getSno());
//
...
//
//        boolean ok = seatService.releaseSeat(req.getMno(), req.getSno(), req.getShowId());
//
...
//        boolean ok = seatService.confirmSeats(req.getMno(), req.getSnos(), req.getShowId(), reason);
...
//    // ------------------------------------------------------------
//    @PostMapping("/getMap")
//    public ResponseEntity<SeatsDto.MapResponse> getSeatMap(@RequestParam String userId, @RequestParam int gno) {
//
//        Map<String, String> statusMap = seatService.getSeatStatusMap(gno, userId);
//
//        return ResponseEntity.ok(new SeatsDto.MapResponse(statusMap));
//    }   // func end
//}   // class end
//
